...
import com.mozhimen.basick.utilk.android.app.applyResult_ofOK
import com.mozhimen.basick.utilk.android.app.applyResult_ofCANCELED
...
import com.mozhimen.basick.utilk.kotlin.UtilKLazyJVM.lazy_ofPublication
...
//        }
            lifecycleScope.launch {
                try {
                    ...
                    UtilKPackageInstallerSession.commit_use_ofActivity(_packageInstallerSession, intent, 0, CPendingIntent.FLAG_IMMUTABLE)
                } catch (e: Exception) {
                    e.printStackTrace()
